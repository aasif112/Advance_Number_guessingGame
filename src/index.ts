...
// console.log(randomNumber)        // To check result print.
...
async function updateScore(message:string, userNumber:number) {
    console.log(`\t ${message}`)
    userAttempt++
    // console.log(`Chances made: ${userAttempt}`)
    remainAttempt--
